...
use crate::env::{
    assembly_script_abort, assembly_script_date, assembly_script_seed, assembly_script_trace,
    ...
    fn resolver(&self, store: &Store) -> ImportObject {
        imports! {
            "env" => {
                ...
                "trace" => Function::new_native_with_env(store, self.env.clone(), assembly_script_trace),
            },
            "Date" => {
                "now" =>  Function::new_native_with_env(store, self.env.clone(), assembly_script_date),
            },
            "massa" => {
