(module
 ...
 (data (i32.const 1096) "\01\00\00\00\06\00\00\00f\00o\00o")
 (data (i32.const 1116) "\1c")
 (data (i32.const 1128) "\01\00\00\00\06\00\00\00y\00o\00u")
 (data (i32.const 1148) "<")
 ...
 (export "main" (func $export:assembly/foo_caller/main))
 (start $~start)
 ...
 (func $export:assembly/foo_caller/main (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
