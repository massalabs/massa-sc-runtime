(module
 ...
 (import "massa" "assembly_script_call" (func $assembly/massa/assembly_script_call (param i32 i32) (result i32)))
 ...
 (memory $0 1)
 (data (i32.const 1036) ",")
 (data (i32.const 1048) "\01\00\00\00\1c\00\00\00g\00e\00t\00_\00s\00t\00r\00i\00n\00g\00.\00w\00a\00t")
 (data (i32.const 1084) ",")
 (data (i32.const 1096) "\01\00\00\00\12\00\00\00g\00e\00t\00S\00t\00r\00i\00n\00g")
 (data (i32.const 1132) "<")
 ...
 (export "main" (func $assembly/caller/main))
 ...
 (func $assembly/caller/main (result i32)
  (local $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 12
  i32.sub
